...
export default function Home() {
  const containerStyle = 'flex px-10 flex-1 gap-2 flex-wrap-reverse justify-center max-md:flex-col max-md:my-10 ';
  return (
    <div className="flex flex-1 gap-[50px] flex-col mt-10 justify-center items-center max-md:gap-0">
      ...
      >
        <div className="flex flex-1 flex-col justify-center">
          <h2
            className="font-bold text-[95px] leading-[90px] text-[#333333] max-md:text-[60px] max-md:leading-[60px]"
          >Ignite Society</h2>
          <h4
      ...
      >
        ...
        <div
          className="flex-1 flex flex-col justify-center gap-10 max-md:gap-[5px] "
        >
          <h2 className="text-[48px] text-[#333333] leading-[48px] font-medium max-md:text-[20px]">Get To Know Us.</h2>

          <div
            className="gap-5 flex flex-col"
          >
            <p className="font-medium text-[31px] leading-[31px] text-[#626262] max-md:text-[30px]">Introducing the Ignite Society</p>
            <p
              className="font-medium text-[20px] leading-[20px] text-justify max-md:text-[13px]"
      ...
      >
        <h2
          className="font-medium text-[48px] z-[1] leading-[48px] text-[rgb(230,96,96)] max-md:text-[30px]"
      ...
      >
        ...
        >
          ...
          >
            <h4
              className="font-medium text-[31px] leading-[31px] text-[#DBDBDB] max-md:text-center max-md:tracking-wider"
            >Project Development</h4>
            <div
              className="flex flex-1 gap-2 max-md:flex-col max-md:items-center"
            >
              ...
              />
              <p
                className="font-normal flex-1 text-white text-justify text-[20px] leading-[20px] opacity-70 max-md:text-[16px]" 
          ...
          >
            <h4
              className="font-medium text-[31px] leading-[31px] text-[#DBDBDB] text-end mb-5 max-md:text-center max-md:tracking-wider"
            >Project Development</h4>
            <div
              className="flex flex-1 gap-2 max-md:flex-col max-md:items-center"
            >
